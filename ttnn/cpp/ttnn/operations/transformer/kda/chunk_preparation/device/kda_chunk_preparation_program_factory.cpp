...
ProgramDescriptor KdaChunkPreparationProgramFactory::create_descriptor(
    ...
    reader_compile_args.push_back(attrs.v_flat ? 1U : 0U);
    reader_compile_args.push_back(attrs.qk_flat ? 1U : 0U);
    reader_compile_args.push_back(attrs.gate_flat ? 1U : 0U);
    ...
    compute.kernel_source =
        "ttnn/cpp/ttnn/operations/transformer/kda/chunk_preparation/device/kernels/compute/"
        "kda_chunk_preparation.cpp";
    compute.source_type = KernelDescriptor::SourceType::FILE_PATH;
    compute.core_ranges = cores;
    compute.compile_time_args = dimensions;
    compute.compile_time_args.push_back(attrs.normalize_qk ? 1U : 0U);
    compute.compile_time_args.push_back(float_bits(attrs.scale));
