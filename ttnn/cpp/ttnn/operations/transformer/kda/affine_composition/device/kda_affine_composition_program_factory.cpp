...
tt::tt_metal::ProgramDescriptor KdaAffineCompositionProgramFactory::create_descriptor(
    const KdaAffineCompositionParams& attrs, const KdaAffineCompositionInputs& in, std::vector<Tensor>& outputs) {
    ...
    TT_FATAL(
        ...
        "affine composition supports at most {} group workers, got {}",
    ...
    dataflow.kernel_source =
        "ttnn/cpp/ttnn/operations/transformer/kda/affine_composition/device/kernels/dataflow/"
        "reader_writer_kda_affine_composition.cpp";
    ...
    compute.kernel_source =
        "ttnn/cpp/ttnn/operations/transformer/kda/affine_composition/device/kernels/compute/"
        "kda_affine_composition.cpp";
